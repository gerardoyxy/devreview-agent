...
NudgeThis is the public name. Public documentation, product interface and marketing copy use English. Existing `devreview` CLI commands and technical integration names remain compatible. The landing and application share ultramarine accents, pale surfaces, Archivo typography and precise borders. User color and font customization takes precedence over those defaults. See [the design system](DESIGN.md).
