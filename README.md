...
DevReview is an experimental, local-first visual feedback layer for coding agents. Select an
...
Close the modal to continue QA. Reopen it from the DevReview button or an element's
