...
`NUDGETHIS_ALLOW_AGENT_TESTS=1 npm run test:agents`. Default application tests run with
execution disabled; their results do not establish transport or provider compatibility.
