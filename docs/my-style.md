...
feature is available in the current source on `main`; the `v0.3.0-alpha.2` downloads predate it.
...
Rust stores profiles in the local `.devreview` SQLite database. Mutations use a revision check;
