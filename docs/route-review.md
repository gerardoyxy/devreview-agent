...
The browser uses a new temporary profile inside ignored `.devreview/`. Existing browser
...
`devreview doctor` and Workspace setup report whether a supported executable was found,
