...
$('#connect-form').onsubmit = event => { event.preventDefault(); token = $('#token-input').value.trim(); sessionStorage.setItem('nudgethis-token', token); $('#connect-dialog').close(); void connect(); };
